...
class ClientIOInfoBox {
    ...
    public static ClientIOInfoBox get( final ClientIOInitHandler handler ) {
        if( INSTANCE == null ) {
            INSTANCE = new ClientIOInfoBox( handler );
        }
        return INSTANCE;
    }
    ...
    private ClientIOInfoBox( final ClientIOInitHandler handler ) {
        ...
        popup.add( ClientIOWidget.createWidget( handler ), 0, 0 );
