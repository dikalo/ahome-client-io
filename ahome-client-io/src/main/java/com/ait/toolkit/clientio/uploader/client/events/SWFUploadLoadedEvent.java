 ...
 * This class should not be instantiated directly, but instead you should create a {@link SWFUploadLoadedHandler} and
 * register it via the {@link com.ait.toolkit.clientio.uploader.client.Uploader#setSWFUploadLoadedHandler(SWFUploadLoadedHandler)}
 * <p/>
 ...
 * make use of the {@link com.ait.toolkit.clientio.uploader.client.Uploader#isAjaxUploadWithProgressEventsSupported()}
 * method.
 * <p/>
 *
...
public class SWFUploadLoadedEvent {
    ...
    /**
     * This constructor is intended for internal use only.  You should not create Uploader loaded events
     * directly, but instead should register a {@link SWFUploadLoadedHandler}.
     */
