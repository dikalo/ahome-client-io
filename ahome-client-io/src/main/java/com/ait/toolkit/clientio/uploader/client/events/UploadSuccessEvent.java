 ...
 * This class should not be instantiated directly, but instead you should create a {@link UploadSuccessHandler} and
 * register it via the {@link com.ait.toolkit.clientio.uploader.client.Uploader#setUploadSuccessHandler(UploadSuccessHandler)}
...
public class UploadSuccessEvent extends UploadEvent {
    ...
    /**
     * This constructor is intended for internal use only.  You should not create uploader success events
     * directly, but instead should register a {@link UploadSuccessHandler}.
     *
     * @param file The native javascript object containing the details of the file being uploaded.
     * @param serverData Any HTTP response data sent from the server at the completion of the uploader.
     * @param responseReceived The HTTP response code sent from the server at the completion of the uploader.
     */
