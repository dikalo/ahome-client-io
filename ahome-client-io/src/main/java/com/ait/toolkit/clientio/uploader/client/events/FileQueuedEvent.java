 ...
 * This class should not be instantiated directly, but instead you should create a {@link FileQueuedHandler} and
 * register it via the {@link com.ait.toolkit.clientio.uploader.client.Uploader#setFileQueuedHandler(FileQueuedHandler)}
 * method in order to access file queued events.
 * <p/>
