 ...
 * This class should not be instantiated directly, but instead you should create a {@link UploadErrorHandler} and
 * register it via the {@link com.ait.toolkit.clientio.uploader.client.Uploader#setUploadErrorHandler(UploadErrorHandler)}
...
public class UploadErrorEvent extends UploadEvent {
    ...
    /**
     * This constructor is intended for internal use only.  You should not create uploader error events
     * directly, but instead should register a {@link UploadErrorHandler}.
     *
     * @param file      The native javascript object containing the details of the file being uploaded.
     * @param errorCode The error code returned by the Uploader component in the case of an uploader failure.
    ...
    /**
     * The error code returned by the Uploader component in the case of an uploader failure, conveniently
