...
public interface UploadCompleteHandler {
    ...
    /**
     * This method is fired whenever a uploader completion event occurs in the Uploader component.  See
     * the {@link UploadCompleteEvent} class for more details on the data available when this event is fired.
     *
