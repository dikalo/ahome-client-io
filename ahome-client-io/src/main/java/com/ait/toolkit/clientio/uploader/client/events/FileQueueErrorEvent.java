 ...
 * This class should not be instantiated directly, but instead you should create a {@link FileQueueErrorHandler} and
 * register it via the {@link com.ait.toolkit.clientio.uploader.client.Uploader#setFileQueueErrorHandler(FileQueueErrorHandler)}
 * method in order to access file queue error events.
 * <p/>
...
public class FileQueueErrorEvent {
     ...
     * @param errorCode The error code returned by the Uploader component in the case of a file queue failure.
    ...
    /**
     * The error code returned by the Uploader component in the case of a file queu failure, conveniently
